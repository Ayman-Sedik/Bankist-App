...
// Data Contains: owner, movements, interestRate, pin, movement dates, currency and locale
const account1 = {
  owner: 'Ayman Sedik',
...
// Display Summary using Magic of Chaining Methods
...
btnLogin.addEventListener('click', function (e) {
  ...
  // use optional chaining to check if the current account exists
...
/*
// use More Ways of Creating and Filling Arrays
